...
def summary(request, pk):
    ...
    return render(request, 'crm/summary.html', {'customer': customer,'products': products,'services': services,'sum_service_charge': sum_service_charge,'sum_product_charge': sum_product_charge,})
...
def product_list(request):
   products = Product.objects.filter(pickup_time__lte=timezone.now())
